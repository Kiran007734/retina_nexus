...
const titles: Record<string, { title: string; crumb: string }> = {
  '/platform': { title: 'Good morning', crumb: 'Dashboard' },
  '/platform/screening/new': { title: 'Start a new screening', crumb: 'New screening' },
  '/platform/screening/results': { title: 'Screening result', crumb: 'New screening / Result' },
  '/platform/screening/explain': { title: 'Explainability', crumb: 'Screening / Evidence verification' },
  '/platform/history': { title: 'Screening history', crumb: 'Screening history' },
  '/platform/patients': { title: 'Patient directory', crumb: 'Patients' },
  '/platform/review': { title: 'Clinical review', crumb: 'Clinical review' },
  '/platform/reports': { title: 'Reports', crumb: 'Reports' },
  '/platform/analytics': { title: 'Care intelligence', crumb: 'Analytics' },
  '/platform/monitoring': { title: 'Model monitoring', crumb: 'Model monitoring' },
  '/platform/settings': { title: 'Workspace settings', crumb: 'Settings' },
  '/platform/datasets': { title: 'Dataset management', crumb: 'Admin / Data governance' },
  '/platform/demo': { title: 'Controlled demo', crumb: 'Verification' },
};

export function Header({ onMenu }: { onMenu: () => void }) {
  const { pathname } = useLocation();
  const copy = titles[pathname] ?? titles['/platform'];
