...
export function ExplainabilityPage() {
  ...
  return <div className="space-y-6">
    <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
      <div className="flex items-center gap-3"><Link to="/platform/screening/results" state={{ imageId }} aria-label="Back to screening result" className="rounded-xl border border-line bg-white p-2.5 text-slate-500 hover:border-teal-300 hover:text-teal-600"><ArrowLeft size={17} /></Link><div><p className="text-xs font-semibold text-slate-400">Screening {'->'} explanation and verification</p><h2 className="section-title mt-1 text-xl font-extrabold">Explainability</h2></div></div>
